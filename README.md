...
InnoSky is the ultimate space for work and life: <br/>
...
**InnoSky changes everything.**

InnoSky is a work-and-lifestyle space to find, build, and collaborate with agent teammates that grow with you. In InnoSky, we treat **Agents as the unit of work**, providing an infrastructure where humans and agents co-evolve.
...
```fish
$ git clone https://github.com/innosky/innosky.git
$ cd innosky
$ pnpm install
