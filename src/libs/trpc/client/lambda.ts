...
const slowProcedures = new Set<string>();
...
export const lambdaClient: any = createTRPCClient<LambdaRouter>({
  links,
});

const createDisabledMarketNode = (): any =>
  new Proxy(
    {},
    {
      get: (_target, prop: string) => {
        ...
        return createDisabledMarketNode();
      },
    },
  );

lambdaClient.market = createDisabledMarketNode();
